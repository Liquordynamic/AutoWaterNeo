                        ...
                        <div className="mt-4 grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-6 pb-6">
                            ...
                            <div className="col-span-full border-b border-gray-900/10 pb-4">
                                ...
                                <div className="sm:col-span-3">
                                    <label htmlFor="dirroot" className="block text-sm/6 font-medium text-gray-900">dirroot</label>
                                    <div>
                                        <input
                                            id="dirroot"
                                            name="dirroot"
                                ...
                                <div className="sm:col-span-3">
                                    <label htmlFor="resroot" className="block text-sm/6 font-medium text-gray-900">resroot</label>
                                    <div>
                                        <input
                                            id="resroot"
                                            name="resroot"
                                ...
                                <div className="sm:col-span-3">
                                    <label htmlFor="sim_time" className="block text-sm/6 font-medium text-gray-900">sim_time</label>
                                    <div>
                                        <input
                                            id="sim_time"
                                            name="sim_time"
                                ...
                                <div className="sm:col-span-3">
                                    <label htmlFor="initial_tstep" className="block text-sm/6 font-medium text-gray-900">initial_tstep</label>
                                    <div>
                                        <input
                                            id="initial_tstep"
                                            name="initial_tstep"
                                ...
                                <div className="sm:col-span-3">
                                    <label htmlFor="massint" className="block text-sm/6 font-medium text-gray-900">massint</label>
                                    <div>
                                        <input
                                            id="massint"
                                            name="massint"
                                ...
                                <div className="sm:col-span-3">
                                    <label htmlFor="saveint" className="block text-sm/6 font-medium text-gray-900">saveint</label>
                                    <div>
                                        <input
                                            id="saveint"
                                            name="saveint"
